...
$prevUrl = $currentPage > 1
    ? buildReportsPageUrl($currentPage - 1, $filter_intara, $filter_itorero, $filter_month)
    : null;
$nextUrl = $currentPage < $totalPages
    ? buildReportsPageUrl($currentPage + 1, $filter_intara, $filter_itorero, $filter_month)
    : null;
$firstUrl = buildReportsPageUrl(1, $filter_intara, $filter_itorero, $filter_month);
$lastUrl = buildReportsPageUrl($totalPages, $filter_intara, $filter_itorero, $filter_month);
?>
    ...
    <div class="pagination-controls">
        ...
        <div class="pagination-group pagination-group--pages" role="list">
            <?php foreach ($paginationItems as $item): ?>
                ...
                <?php else: ?>
                    <a href="<?= htmlspecialchars(buildReportsPageUrl((int) $item, $filter_intara, $filter_itorero, $filter_month)) ?>"
