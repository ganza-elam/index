...
?>
<div class="section receipt-report-section" id="receipt-report" style="padding:20px;border:1px solid #ddd;border-radius:8px;margin-bottom:24px;">
                ...
                <?php foreach ($goneBooklets as $row): ?>
                    <tr>
                        ...
                        <?php if (!$isGuest): ?>
                            ...
                            <td>
                                <form method="POST" style="display:inline;" onsubmit="return confirm('Emeza ko iyi booklet yagarutse?');">
                                    ...
                                    <button type="submit" name="approve_booklet_return" class="edit">Emeza ko yagarutse</button>
                                </form>
                            </td>
                        <?php endif; ?>
                    </tr>
